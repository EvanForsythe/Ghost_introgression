...
# Optionally highlight specific subset (if needed)
# subset_df = scaling_quant_df[scaling_quant_df["Job_name"].str.contains("true")]
# sns.scatterplot(data=subset_df, x="Scaling_factor", y="rep_pop_mean", color="red", label="True Jobs")
